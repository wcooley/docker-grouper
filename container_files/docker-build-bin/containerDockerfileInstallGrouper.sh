...
runCmd "mkdir -p $webAppDir/WEB-INF $webAppDir/conf $webAppDir/WEB-INF/lib $webAppDir/WEB-INF/libUiAndDaemon $webAppDir/WEB-INF/libWs $webAppDir/WEB-INF/classes/grouperText $webAppDir/WEB-INF/bin"
...
runCmd "chown -R tomcat.root $containerDir/grouper/logs"
runCmd "chmod -R g+rwxs $containerDir/grouper/logs/"
...
runCmd "cp -p $mountDir/tier-support/log4j_fix/tomcatBin/log4j-* $containerTomcatDir/bin/"
runCmd "cp -p $mountDir/tier-support/log4j_fix/tomcatLib/slf4j-* $containerTomcatDir/lib/"

runCmd "rm -f $webAppDir/WEB-INF/lib/slf4j-api-*"

runCmd "cp -p $mountDir/tier-support/log4j_fix/webinfLib/* $webAppDir/WEB-INF/lib/"
